...
#do fastqc using fastqc for experiment zy_ck
nohup sh /home/jwman/chipseq-automation/script/zy_ck_clean.sh >/home/jwman/chipseq-automation/log/zy_ck_clean.log 2>&1 &
